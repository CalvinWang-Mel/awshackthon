...
# mapbox_access_token = "pk.eyJ1Ijoic3RldmVuY2hlbmRhbiIsImEiOiJjazA0aDU3eXgzZnAwM25tamVjeTN3enNjIn0.7wUdkPGMkJeRPKSBkZa9ww"
...
df1 = pd.read_csv("assets/uber-rides-data1.csv", dtype=object)

df2 = pd.read_csv("assets/uber-rides-data2.csv", dtype=object)

df3 = pd.read_csv("assets/uber-rides-data3.csv", dtype=object)
...
if __name__ == "__main__":
    ...
    app.run_server(debug=True, **flask_run_options)

    # Prod server
    # http_server = WSGIServer(('', 8050), app)
